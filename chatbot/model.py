...
from chatbot.textdata_triples import Batch
    ...
    def buildNetwork(self):
        ...
        if self.args.test:
            if not outputProjection:
                self.outputs = tf.nn.ctc_beam_search_decoder(decoderOutputs, self.args.maxLengthDeco, beam_width=100, top_paths=10, merge_repeated=True)
            else:
